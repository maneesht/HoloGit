...
describe('GitPoller: Pull Requests', () => {
    ...
    it('should return an array', () => {
        ...
        return GitPoller.getPullRequests('torvalds', 'linux', null).then((data) => {
            expect(data).to.be.an('array')
        });
    });
    ...
    it('should have a value of number on the pull requests', () => {
        //github.com/torvalds/linux
        return GitPoller.getPullRequests('torvalds', 'linux', null).then((data: Array<object>) => {
    ...
    it('should return an empty array when no pull requests exist', () => {
        //github.com/maneesht/todo-app
        return GitPoller.getPullRequests('maneesht', 'todo-app', null).then((data) => {
            expect(data).to.be.an('array');
    ...
    it('should return an array of size 5', () => {
        ...
        return GitPoller.getPullRequests('tslocke', 'hobo', null).then((data) => {
            expect(data).to.be.an('array');
    ...
    it('should return the correct information', () => {
        ...
        return GitPoller.getPullRequests('tslocke', 'hobo', null).then((data: Array<object>) => {
            expect(data).to.deep.equal(expected);
        })
    })
});

describe('GitPoller: Get Repos', () => {
    it('should return a list of null repos', () => {
        return GitPoller.getReposByUser('maneesht').catch(data => {
            expect(data.error.message).to.equal("Requires authentication");
            expect(data.statusCode).to.equal(401);
        });
    });
    it('should authenticate and get repos', () => {
        let username = 'maneesht';
        let password = 'maneesh29';
